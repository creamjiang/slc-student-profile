        ...
        {            
            ...
            if (Session["access_token"] == null)
            {
                ...
                if (Request.QueryString["code"] == null)
                {
                    ...
                    string authorizeUrl = string.Format("https://api.sandbox.slcedu.org/api/oauth/authorize?client_id={0}&redirect_uri={1}", Global.Constants.clientId, Global.Constants.redirectUri);
                ...
                else
                {
                    ...
                    string sessionUrl = string.Format("https://api.sandbox.slcedu.org/api/oauth/token?client_id={0}&client_secret={1}&grant_type=authorization_code&redirect_uri={2}&code={3}", Global.Constants.clientId, Global.Constants.clientSecret, Global.Constants.redirectUri, code);
